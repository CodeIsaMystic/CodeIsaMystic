...
<div align="center">
  ...
  <h1>Julien Orjollet "Web Developer"</h1>
  
  <h3>Some personal info for professional purpose</h3>
...
<p>Welcome!!  You can reach here everything about my github profile...
</p>
...
As "product oriented programmer",  working to upgrade my skills, experiences and methodologies. 
I'm Julien from Lyon (France), eternal learner, on the road to build my web expertise... 

- 🌱 I like learning Javascript, Reactjs, database and computer science. Trying to mastering my working approach.
- 🔭 I’m currently looking for a job in the industry taking the next step of my path of being a software ingeneer. 
- 📫 How to reach me: julienorjollet.wd@gmail.com
- 🐱‍👤 Tech: Javascript, React / Redux, NodeJS, PHP 
- ⚡ Book: EloquentJS "A modern introduction to programming" of Marijn Haverbeke
...
"Coding" is not a passion, but a lifestyle, I built a way of working every day !  
Getting challenges and being aware of how I should handle the various situations I may enconter...

## Designing...

Designs matters... From the beginning of my path to be that developer, I've always reached out how to have that Big Picture in order to have a better understanding of my works or studies. 

"Reading" layouts design, thinking in terms of designing an application or in terms of design pattern in pure programming, Design is always representing the core of the problem we attempt to solve. 


## Focusing the product

How our work's related with the User Experience and the products we build, are also to me a "main focus".

I am attempting to develop softwares and thinking the potentials issues we could encounter globally, taking the responsability doing great job thinking in terms of "states Management, Control Flow and Code Volume" in my Front End perspective.
...
### Reactjs.org 
Some React app from various workshop manipulating APIs, React, Redux... 
...
[![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=CodeIsaMystic&repo=amazon-styled-comp-ts)](https://github.com/CodeIsaMystic/amazon-styled-comp-ts) 
...
### Nodejs 
A simple approach of Nodejs by implementing servers, CRUD...
...
### Testing
Testing with Jest, React-testing-library, Enzyme...
